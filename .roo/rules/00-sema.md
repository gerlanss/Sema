...
Capacidade padrÃƒÆ’Ã‚Â£o deste cliente: fraca.
...
- EvidÃƒÆ’Ã‚Âªncias: descrever padrão visual escolhido, explicar como o domínio aparece na interface ou terminal, confirmar responsividade básica, provar mobile sem overflow horizontal com scrollWidth <= clientWidth, listar estados essenciais.

...
- Estagio atual: linha publica `1.5.3` alinhada para release estavel com persistencia vendor-first, drift com escopo real, impact map, renomeacao semantica assistida, `doctor` mais util, `verificar` corrigido e matcher JS/TS mais forte para prototype browser-side
...
- Linha publica de release: `1.5.3`, alinhada entre CLI, MCP, pacotes internos, extensao do VS Code, instaladores e documentacao
...
- `[x]` Alinhar patch `1.5.3` com resolucao de `Object.assign(...prototype...)`, entrada padrao da CLI mais segura e docs atualizadas

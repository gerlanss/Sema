...
Sema 0.8.2 fortalece a importacao de `Next.js App Router` em casos reais onde o handler usa `request.json()` com tipo/cast inline e retorna `NextResponse.json(...)` via variavel local.

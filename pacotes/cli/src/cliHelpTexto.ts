...
export function criarAjudaRaiz(versao: string): string {
  return [
    ...
    renderizarSecaoAscii("Fluxos rápidos", [
      ...
      "sema analisar <estado.json> [--modelo <dir>] [--checkpoint <arquivo>] [--dispositivo <auto|cuda|cpu>] [--json]",
      "sema planejar <pedido.json> [--modelo <dir>] [--checkpoint <arquivo>] [--dispositivo <auto|cuda|cpu>] [--json]  # Intelligence primeiro; plano somente, sem execução",
      "sema executar-plano <plano.json> --json  # Codex executor; recalcula o guard e executa somente gates locais allowlistados",
      "sema ciclo-local <pedido.json> [--modelo <dir>] [--checkpoint <arquivo>] [--dispositivo <auto|cuda|cpu>] [--json]  # Intelligence -> guard -> executor local",
      "sema observar [--porta <1024-65535>] [--host 127.0.0.1]",
      "",
    ...
    renderizarSecaoAscii("Comandos principais", [
      ...
      "auditoria: sema drift <arquivo-ou-pasta> [--escopo <arquivo|modulo|projeto>] [--cache <none|cache|fresh>] [--incluir-worktrees] [--incluir-consumidores-laterais] [--pacote] [--json]",
    ...
    renderizarSecaoAscii("Ajuda IA-first", [
      ...
      "sema contexto-ia <arquivo.sema> [--saida <diretorio>] [--capacidade <fraca|media|forte>] [--pacote] [--json]",

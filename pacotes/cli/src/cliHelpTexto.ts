...
export function criarAjudaRaiz(versao: string): string {
  return [
    ...
    renderizarSecaoAscii("Comandos principais", [
      ...
      "importação: sema importar <nestjs|express|fastify|koa|fastapi|flask|nextjs|nextjs-consumer|react-vite-consumer|angular-consumer|flutter-consumer|firebase|dotnet|java|go|rust|cpp|php|typescript|python|dart> <diretorio> [--saida <diretorio>] [--namespace <base>] [--json]",

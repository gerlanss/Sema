...
export function ajuda(): string {
  return [
    ...
    renderizarSecaoAscii("Comandos principais", [
      ...
      "geração: sema compilar <arquivo-ou-pasta> --alvo <typescript|python|php|dart|lua|javascript|html|css> --saida <diretorio> [--estrutura <flat|modulos|backend>] [--framework <base|nestjs|fastapi>]",
      "teste local: sema testar <arquivo.sema> --alvo <typescript|python|php|dart|lua|javascript|html|css> --saida <diretorio-temporario> [--estrutura <flat|modulos|backend>] [--framework <base|nestjs|fastapi>]",

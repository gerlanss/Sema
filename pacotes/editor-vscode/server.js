...
const descricoesHover = {
  ...
  database: "Declara uma superficie de persistencia vendor-first com engine, consistencia, durabilidade e recursos vivos.",
  ...
  auth: "Declara autenticacao explicita para task, route ou superficie.",
  authz: "Declara autorizacao explicita com papeis, escopos, politica e tenant.",
  dados: "Classifica dados, define redacao de log e retencao semantica.",
  audit: "Declara trilha auditavel com evento, ator, correlacao e motivo.",
  segredos: "Declara governanca de segredos, origem, escopo, rotacao e protecoes.",
  forbidden: "Declara operacoes proibidas para conter abuso, vazamento e efeitos perigosos.",
  impl: "Liga o contrato ao simbolo real do runtime.",
  vinculos: "Liga o contrato a arquivo, simbolo, recurso ou superficie viva.",
  execucao: "Declara timeout, retry, compensacao, idempotencia e criticidade operacional.",
  ...
  worker: "Declara uma superficie de execucao assíncrona ligada a task.",
  evento: "Declara uma superficie baseada em evento ou mensagem semantica.",
  fila: "Declara uma superficie de fila com contrato explicito.",
  cron: "Declara uma superficie agendada com execucao governada.",
  webhook: "Declara uma superficie HTTP/evento externa ou interna.",
  cache: "Declara uma superficie de cache observavel pela semantica.",
  storage: "Declara uma superficie de storage/recurso com contrato rastreavel.",
  policy: "Declara uma superficie de politica operacional ou de acesso.",
  capabilities: "Lista capacidades nativas expostas por uma engine de persistencia.",
  table: "Declara um recurso relacional de tabela dentro de um bloco database.",
  index: "Declara um indice vivo associado ao recurso principal do banco.",
  relationship: "Declara uma relacao semantica entre recursos persistidos.",
  query: "Declara consulta, pipeline ou superficie de leitura canonica do banco.",
  retention: "Declara politica de retencao, expurgo ou TTL sobre dados persistidos.",
  lock: "Declara comportamento de lock relevante para o contrato operacional.",
  replication: "Declara estrategia de replicacao e leitura/escrita distribuida.",
  collection: "Declara uma colecao documental em engines orientadas a documento.",
  document: "Declara um shape documental materializado ou snapshot persistido.",
  keyspace: "Declara um espaco de chaves em engines key-value como Redis.",
  stream: "Declara stream persistente ou superficie de eventos do banco.",
  consumer_group: "Declara grupo consumidor associado a stream persistente.",
  pub_sub: "Declara topico efemero de publicacao e assinatura em banco de estado.",

...
function gerarCabecalhoSemaHtml(modulo: IrModulo): string {
  return `<!--
SEMA-GOVERNED
Módulo de origem: ${escaparHtml(modulo.nome)}
...
Descrição: página HTML gerada para humanos e IAs entenderem rapidamente a intenção do contrato.
-->`;
}
...
${gerarCabecalhoSemaHtml(modulo)}
<html lang="pt-BR">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="Contrato Sema: ${escaparHtml(modulo.nome)}">
  <meta name="sema-governed" content="true">
  <meta name="sema-module" content="${escaparHtml(modulo.nome)}">

// SEMA-GOVERNED: sema.produto.persistencia_vendor_first
// Descricao: contratos de persistencia suportados pelo nucleo; consulte contratos/sema/persistencia_vendor_first.sema antes de editar.
